...
@Component({
  selector: 'cfs-view-nmdc-ins',
  templateUrl: './view-nmdc-ins.component.html',
  styleUrls: ['./view-nmdc-ins.component.scss']
})
export class ViewNmdcInsComponent implements OnInit {
  ...
  // getInfraCons(propId) {
  //   this.api.getbuildConstructionnmdc(this.districtCode, this.componentId).subscribe(
  //     (res) => {
  ...
  //         }, 100);
  //       }
  //       this.proposedArea = this.isInfraConstruction.reduce(
  //         (sum, item) => sum + Number(item.proposedArea),
  //         0
  //       );
  //       this.perUnitCost = this.isInfraConstruction.reduce(
  //         (sum, item) => sum + Number(item.perUnitCost),
  //         0
  //       );
  //       this.totalCost = this.isInfraConstruction.reduce(
  //         (sum, item) => sum + Number(item.totalCost),
  //         0
  //       );
  //     },
