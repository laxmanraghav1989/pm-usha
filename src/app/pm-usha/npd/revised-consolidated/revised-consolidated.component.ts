...
@Component({
  selector: 'cfs-revised-consolidated',
  templateUrl: './revised-consolidated.component.html',
  styleUrls: ['./revised-consolidated.component.scss']
})
export class RevisedConsolidatedComponent implements OnInit {
  ...
  nmdcconsolidatedList: any[];
  nmdcconsolidatedMatchList: any[];
  ...
  getFNPD(value){
    if(value === '2'){
      const genderconsolidatedList1 = this.genderconsolidatedList.filter(e => (e.proposalRevisionApprovedBySaa === true && e.finalRevisedProposalLockStatus === true && e.revisedProposalForwardedtoNpd !== true))
      const genderconsolidatedList2 = this.genderconsolidatedList.filter(e => (e.revisedProposalForwardedtoNpd === true))
      this.allConslidatedGie = genderconsolidatedList1.length + genderconsolidatedList2.length;

      if (this.userTypeId === this.sharedService.userTypeList['1'].id || this.userTypeId === this.sharedService.userTypeList['2'].id || this.userTypeId === this.sharedService.userTypeList['12'].id) {
        this.consolidatedList = this.genderconsolidatedList.filter(e => (e.proposalRevisionApprovedBySaa === true && e.finalRevisedProposalLockStatus === true && e.revisedProposalForwardedtoNpd !== true))
      }
      ...
      this.tempConsolidatedListGie = [...this.consolidatedList]
    ...
    if(value === '3'){
      const nmdcconsolidatedList1 = this.nmdcconsolidatedList.filter(e => (e.proposalRevisionApprovedBySaa === true && e.finalRevisedProposalLockStatus === true && e.revisedProposalForwardedtoNpd !== true))
      const nmdcconsolidatedList2 = this.nmdcconsolidatedList.filter(e => (e.revisedProposalForwardedtoNpd === true))
      this.allConslidatedGie = nmdcconsolidatedList1.length + nmdcconsolidatedList2.length;

      if (this.userTypeId === this.sharedService.userTypeList['1'].id || this.userTypeId === this.sharedService.userTypeList['2'].id || this.userTypeId === this.sharedService.userTypeList['12'].id) {
        this.consolidatedList = this.nmdcconsolidatedList.filter(e => (e.proposalRevisionApprovedBySaa === true && e.finalRevisedProposalLockStatus === true && e.revisedProposalForwardedtoNpd !== true))
      }
      if (this.userTypeId === this.sharedService.userTypeList['0'].id || this.userTypeId === this.sharedService.userTypeList['6'].id || this.userTypeId === this.sharedService.userTypeList['7'].id || this.userTypeId === this.sharedService.userTypeList['10'].id || this.userTypeId === this.sharedService.userTypeList['8'].id || this.userTypeId === this.sharedService.userTypeList['9'].id) {
        this.consolidatedList = this.nmdcconsolidatedList.filter(o => o.revisedProposalForwardedtoNpd === true)
      }
      this.tempConsolidatedListGie = [...this.consolidatedList]
  ...
  getConsolidate() {
    ...
    this.getService.getfinalSubmitProposal(payload).subscribe(res => {
      if (this.componentId === 0 || this.componentId === 1 || this.componentId === 2 || this.componentId === 3) {
        this.fnpd = '1'
      }
      ...
      this.genderconsolidatedMatchList = this.genderconsolidatedList;
      this.nmdcconsolidatedList = this.consolidatedList.filter(o => (o.componentId === this.sharedService.nmdcComponentId) && (o.pabActionId === 1 || o.pabActionId === 3))
      this.nmdcconsolidatedMatchList = this.nmdcconsolidatedList;
      ...
      this.consolidatedMatchList = this.consolidatedList;
      ...
      if(this.fnpd === '1'){
        if (this.userTypeId === this.sharedService.userTypeList['1'].id || this.userTypeId === this.sharedService.userTypeList['2'].id || this.userTypeId === this.sharedService.userTypeList['12'].id) {
          this.consolidatedListTotal = this.consolidatedList.filter(e => e.revisedProposalForwardedtoNpd === true)
          this.consolidatedList = this.consolidatedList.filter(e => (e.proposalRevisionApprovedBySaa === true && e.finalRevisedProposalLockStatus === true && e.revisedProposalForwardedtoNpd !== true))
          this.allConslidatedMeru = this.consolidatedList.length + this.consolidatedListTotal.length
      ...
      this.totalCost = 0
      let genderConsList=[]
      let genderConsListTotal=[]
      let nmdcConsList=[]
      let nmdcConsListTotal=[]
      if (this.userTypeId === this.sharedService.userTypeList['1'].id || this.userTypeId === this.sharedService.userTypeList['2'].id || this.userTypeId === this.sharedService.userTypeList['12'].id) {
        genderConsListTotal = this.genderconsolidatedList.filter(e => e.revisedProposalForwardedtoNpd === true)
        genderConsList = this.genderconsolidatedList.filter(e => (e.proposalRevisionApprovedBySaa !== true && e.revisedProposalForwardedtoNpd !== true))
        nmdcConsListTotal = this.nmdcconsolidatedList.filter(e => e.revisedProposalForwardedtoNpd === true)
        nmdcConsList = this.nmdcconsolidatedList.filter(e => (e.proposalRevisionApprovedBySaa !== true && e.revisedProposalForwardedtoNpd !== true))

      }
      if (this.userTypeId === this.sharedService.userTypeList['0'].id || this.userTypeId === this.sharedService.userTypeList['6'].id || this.userTypeId === this.sharedService.userTypeList['7'].id || this.userTypeId === this.sharedService.userTypeList['10'].id || this.userTypeId === this.sharedService.userTypeList['8'].id || this.userTypeId === this.sharedService.userTypeList['9'].id) {
        genderConsList = this.genderconsolidatedList.filter(o => o.revisedProposalForwardedtoNpd === true)
        nmdcConsList = this.genderconsolidatedList.filter(o => o.revisedProposalForwardedtoNpd === true)
      }
      if (this.userTypeId === this.sharedService.userTypeList['1'].id || this.userTypeId === this.sharedService.userTypeList['2'].id || this.userTypeId === this.sharedService.userTypeList['12'].id) {
        array = [...this.consolidatedListTotal,...genderConsListTotal, ...nmdcConsListTotal]

      }
      if (this.userTypeId === this.sharedService.userTypeList['0'].id || this.userTypeId === this.sharedService.userTypeList['6'].id || this.userTypeId === this.sharedService.userTypeList['7'].id || this.userTypeId === this.sharedService.userTypeList['10'].id || this.userTypeId === this.sharedService.userTypeList['8'].id || this.userTypeId === this.sharedService.userTypeList['9'].id) {
        array = [...this.consolidatedList,...genderConsList,...nmdcConsList]
      }
      // let array = []
      // if (this.userTypeId === this.sharedService.userTypeList['1'].id || this.userTypeId === this.sharedService.userTypeList['2'].id || this.userTypeId === this.sharedService.userTypeList['12'].id) {
  ...
  getESignTransactionId(compId) {
    let payload = {
      ...
      revisedProposalNdmc: compId === 4 ? true: ''
    }
  ...
  async updateResults() {
    ...
    this.handlePageChange(this.sharedService.page = 1)
      ...
      this.consolidatedList = []
      this.consolidatedList = this.searchByValue(this.tempConsolidatedListGie);
      this.handlePageChange(this.sharedService.page = 1)
    }
  ...
  unlock(item) {
    ...
    let data = {
      ...
      instituteCategory: (item.componentId === 5 || item.componentId === 4) ? '' : characters,
      status: false,
    ...
    this.common.unLockConsolidated(data).subscribe(res => {
      if (res) {
        if (item.componentId === 1 || item.componentId === 2 || item.componentId === 3) {
          this.getConsolidate()
        }
        else {
          this.fnpd = "1";
  ...
  forword() {
    if (this.myCheck1) {
      let payload = {
        type: 'PDF',
        stateCode: this.stateCode,
       componentId: this.fnpd === '1' ? [this.sharedService.meruComponentId, this.sharedService.universityComponentId, this.sharedService.collegeComponentId] : this.fnpd === '3' ? [this.sharedService.nmdcComponentId] : [this.sharedService.genderComponentId],
        proposalRevisionApprovedBySaa: true,
        finalReviseProposalLockStatus: true,
        revisedProposalForwardedToNpd: false,
        pabActionId: 1,
        reportTitle : 'Revised Proposal'
      }
      // if (this.fnpd === '1') {
      //   if (this.allConslidatedMeru !== this.consolidatedMatchList.length) {
      //     this.notification.showValidationMessage(`Please approve all of the PAB approved /conditionally approved proposals (${this.consolidatedMatchList.length}).
      ...
      // }
      // else {
      //   if (this.allConslidatedGie !== this.genderconsolidatedMatchList.length) {
      //     this.notification.showValidationMessage(`Please approve all of the PAB approved/conditionally approved proposals  (${this.genderconsolidatedMatchList.length}).
      //      Unless all of the PAB approved/conditionally aproved proposals are approved by SAA, forwarding to NPD via eSign is not possible!`);
      //     return;
      //   }
      // }
      
      this.getService.downloadDataRevisedConsolidated(payload).subscribe(res => {
        if (res.byteData) {
  ...
  generateXML() {
    ...
    let componentId = this.fnpd === '1' ? [this.sharedService.meruComponentId, this.sharedService.universityComponentId, this.sharedService.collegeComponentId] : this.fnpd === '3' ? [this.sharedService.nmdcComponentId] : [this.sharedService.genderComponentId]
  ...
  tabSelected(value: MatTabChangeEvent) {
      ...
      //     this.componetName = +sessionStorage.getItem('componetFilterName');
      //     this.componentIdList()
      //     this.getSateDataList();
      //     this.proposalOutComesArr = this.cachedTotalData.getData(); // Use cached data
