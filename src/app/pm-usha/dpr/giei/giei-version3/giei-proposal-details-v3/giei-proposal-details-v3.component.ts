...
@Component({
  selector: 'cfs-giei-proposal-details-v3',
  templateUrl: './giei-proposal-details-v3.component.html',
  styleUrls: ['./giei-proposal-details-v3.component.scss']
})
export class GieiProposalDetailsV3Component implements OnInit {
  ...
  constructor(
    ...
    public booleanEntity: BooleanEntity, public deleteService: DeleteService, private route: ActivatedRoute,  private encrypt: EncryptDecrypt
  ) {
  ...
  saveTab1() {
    ...
    const payload = {
        componentId: this.sharedService.genderComponentId,
        description: this.formDataInfraConstruction.controls["description"].value,
        id: this.formDataInfraConstruction.controls["id"].value,
        justification: this.formDataInfraConstruction.controls["justification"].value,
        perUnitCost: this.formDataInfraConstruction.controls["perUnitCost"].value,
        proposedArea: this.formDataInfraConstruction.controls["proposedArea"].value,
        purpose: this.formDataInfraConstruction.controls["purpose"].value,
        stateCode: sessionStorage.getItem("stateCode"),
        districtCode: sessionStorage.getItem("districtCode"),
        totalCost: this.formDataInfraConstruction.controls["totalCost"].value,
        location: this.formDataInfraConstruction.controls["location"].value,
        recordStatusId: this.formDataInfraConstruction.controls['recordStatusId'].value ? this.formDataInfraConstruction.controls['recordStatusId'].value : '',
        rsV3: this.formDataInfraConstruction.controls["id"].value == 0 ? this.sharedService.revAddId : (this.formDataInfraConstruction.controls["rsV3"].value === null ? 0 : this.formDataInfraConstruction.controls["rsV3"].value.id),
        activeStatus: this.formDataInfraConstruction.controls["activeStatus"].value ? this.formDataInfraConstruction.controls["activeStatus"].value : true,
        oldId:this.formDataInfraConstruction.controls["oldId"].value ? this.formDataInfraConstruction.controls["oldId"].value : '',
        oldIdV3:this.formDataInfraConstruction.controls["oldIdV3"].value ? this.formDataInfraConstruction.controls["oldIdV3"].value : '',
        v1:this.formDataInfraConstruction.controls["v1"].value ? this.formDataInfraConstruction.controls["v1"].value : '',
        v2:this.formDataInfraConstruction.controls["v2"].value ? this.formDataInfraConstruction.controls["v2"].value : '',
        v3:this.formDataInfraConstruction.controls["v3"].value ? this.formDataInfraConstruction.controls["v3"].value : '',
    ...
    // this.formDataInfraConstruction.get('recordStatus').setValue(
    //   this.formDataInfraConstruction.controls['id'].value == 0
    //     ? { id: this.sharedService.revAddId, name: this.sharedService.revAdd }
    //     : this.formDataInfraConstruction.controls['recordStatus'].value
    // );

    // this.formDataInfraConstruction.get('rsV3').setValue(
    //   this.formDataInfraConstruction.controls['id'].value == 0
    //     ? { id: this.sharedService.revAddId, name: this.sharedService.revAdd }
    //     : (this.formDataInfraConstruction.controls['rsV3'].value === '' 
    //         ? null 
    //         : this.formDataInfraConstruction.controls['rsV3'].value)
    // );

    // this.formDataInfraConstruction.get('activeStatus').setValue(
    //   this.formDataInfraConstruction.controls['activeStatus'].value
    //     ? this.formDataInfraConstruction.controls['activeStatus'].value
    //     : true
    // );

    // this.formDataInfraConstruction.get('oldId').setValue(
    //   this.formDataInfraConstruction.controls['oldId'].value
    //     ? this.formDataInfraConstruction.controls['oldId'].value
    //     : null
    // );

    // this.formDataInfraConstruction.get('oldIdV3').setValue(
    //   this.formDataInfraConstruction.controls['oldIdV3'].value
    //     ? this.formDataInfraConstruction.controls['oldIdV3'].value
    //     : null
    // );
      // recordStatusId
      this.post
      .saveInfraConstructionGenderRevisionV3(body, this.sharedService.genderComponentId, this.stateCode, this.districtCode, this.common.genderEquityInfroConstruction, formdata)
      .subscribe(
        (res) => {
          if (res.status === 200) {
  ...
  saveInfraRenovation() {
    ...
    let temp = [];
      temp.push({
        ...
        rsV3: this.formDataInfraRenovation.controls["id"].value == 0 ? { id: this.sharedService.revAddId, name: this.sharedService.revAdd } : (this.formDataInfraRenovation.controls["rsV3"].value === '' ? null : this.formDataInfraRenovation.controls["rsV3"].value),
        ...
        v2:this.formDataInfraRenovation.controls["v2"].value,
  ...
  processRenovResponse(res) {
    this.infraRenovationList = [];
     this.newArray = []
      this.deleteFilterArr = res.filter(item => item.rsV3?.id === 2)
      this.updateIdArrFilter = res.filter(item => item.v3 == true && item.rsV3?.id === 3)
            this.item1FilterArray = [...this.updateIdArrFilter, this.existingRecordFilter]
            this.existingRecordFilter = res.filter(item => (item.v2 == true && item.v3 == null))
            this.newFilterArr = res.filter(item => item.v3 == true && item.rsV3?.id === 1)
            this.oldIdArrFilter = res.filter(item => (item.v2 == true && item.v3 == false) && item.rsV3?.id === 3)
            this.updateIdArrFilter.forEach(item1 => {
              this.oldIdArrFilter.forEach(item2 => {
                  if (item1.oldIdV3 === item2.id) {
                      this.newArray.push(item2, item1);
          ...
          this.totalArr = this.infraRenovationList.filter(item => (item.v2 == true && item.rsV3 === null) || (item.v3 == true && item.rsV3 !== null))
    this.itemList = [];
    res.forEach(ele => {
      this.itemList.push({
        id: ele.id,
  ...
  saveEquipmentProcured() {
    ...
    let temp = [];
        temp.push({
          ...
          rsV3: this.formDataEquipmentProcured.controls["id"].value == 0 ? { id: this.sharedService.revAddId, name: this.sharedService.revAdd } : (this.formDataEquipmentProcured.controls["rsV3"].value === '' ? null : this.formDataEquipmentProcured.controls["rsV3"].value),
          ...
          v2:this.formDataEquipmentProcured.controls["v2"].value,
  ...
  getEquipmentData() {
      this.api.getEquipmentGenderEquityRevision(this.districtCode, this.sharedService.genderComponentId, this.sharedService.revAddId).subscribe(
        (res) => {
          this.processEquoResponse(res.data)
        },
        (err) => { }
      );
  }
    ...
    this.newArray = []
     this.deleteFilterArr = res.filter(item => item.rsV3?.id === 2)
      this.updateIdArrFilter = res.filter(item => item.v3 == true && item.rsV3?.id === 3)
          ...
          this.totalArr = this.equipmqntList.filter(item => (item.v2 == true && item.rsV3 === null) || (item.v3 == true && item.rsV3 !== null))
    this.itemList = [];
    res.forEach(ele => {
      this.itemList.push({
        id: ele.id,
  ...
  saveTave4() {
    ...
    let temp = [];
        temp.push({
          ...
          rsV3: this.formDataWorkshop.controls["id"].value == 0 ? { id: this.sharedService.revAddId, name: this.sharedService.revAdd } : (this.formDataWorkshop.controls["rsV3"].value === '' ? null : this.formDataWorkshop.controls["rsV3"].value),
          ...
          oldIdV3:this.formDataWorkshop.controls["oldIdV3"].value ? this.formDataWorkshop.controls["oldIdV3"].value : null,
          v1:this.formDataWorkshop.controls["v1"].value,
          v2:this.formDataWorkshop.controls["v2"].value,
          v3:this.formDataWorkshop.controls["v3"].value,
          versionNo: this.sharedService.pabStatusV3
  ...
  getWorkshop1() {
      this.api.getWorkshopGenderEquityRevision(this.districtCode, this.sharedService.genderComponentId, this.sharedService.revAddId).subscribe(
        (res) => {
          this.processWorkshopResponse(res.data)
          this.saveLockStatus()
        },
        (err) => { }
      );
  ...
  saveTav5() {
    ...
    let temp = [];
      temp.push({
        ...
        rsV3: this.formDataRemedial.controls["id"].value == 0 ? { id: this.sharedService.revAddId, name: this.sharedService.revAdd } : (this.formDataRemedial.controls["rsV3"].value === '' ? null : this.formDataRemedial.controls["rsV3"].value),
        ...
        oldIdV3:this.formDataRemedial.controls["oldIdV3"].value ? this.formDataRemedial.controls["oldIdV3"].value : null,
        v1:this.formDataRemedial.controls["v1"].value,
        v2:this.formDataRemedial.controls["v2"].value,
        v3:this.formDataRemedial.controls["v3"].value,
        versionNo: this.sharedService.pabStatusV3
  ...
  saveVocational() {
    ...
    let temp = [];
      temp.push({
        ...
        rsV3: this.formVocational.controls["id"].value == 0 ? { id: this.sharedService.revAddId, name: this.sharedService.revAdd } : (this.formVocational.controls["rsV3"].value === '' ? null : this.formVocational.controls["rsV3"].value),
        ...
        oldIdV3:this.formVocational.controls["oldIdV3"].value ? this.formVocational.controls["oldIdV3"].value : null,
        v1:this.formVocational.controls["v1"].value,
        v2:this.formVocational.controls["v2"].value,
        v3:this.formVocational.controls["v3"].value,
        versionNo: this.sharedService.pabStatusV3
        ...
        temp = [
          {
            ...
            rsV3: this.formActivities.controls["id"].value == 0 ? { id: this.sharedService.revAddId, name: this.sharedService.revAdd } : (this.formActivities.controls["rsV3"].value === '' ? null : this.formActivities.controls["rsV3"].value),
            ...
            oldIdV3:this.formActivities.controls["oldIdV3"].value ? this.formActivities.controls["oldIdV3"].value : null,
            v1:this.formActivities.controls["v1"].value,
            v2:this.formActivities.controls["v2"].value,
            v3:this.formActivities.controls["v3"].value,
            versionNo: this.sharedService.pabStatusV3
          }
        ]
  ...
  delete(item: any) {
    ...
    this.common.delete().subscribe(res => {
      if (res) {
        if (this.selectedIndex === 0) {
            this.deleteService.deleteInfraNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, false).subscribe(res => {
              if (res.status === 200) {
              ...
              this.deleteService.deleteRenovatedNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, false).subscribe(res => {
                if (res.status === 200) {
                  this.getRenovationData();
                  this.resetTotal()
                  this.notification.showDelete()
              ...
              this.deleteService.deleteEquipmentNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, false).subscribe(res => {
                if (res.status === 200) {
                  this.resetTotal()
                  this.notification.showDelete()
                  this.getEquipmentData();
              ...
              this.deleteService.deleteWorkshopNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, false).subscribe(res => {
                if (res.status === 200) {
                  this.resetTotal()
                  this.notification.showDelete()
                  this.getWorkshop1();
              ...
              this.deleteService.deleteRemedialNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, false).subscribe(res => {
                if (res.status === 200) {
                  this.resetTotal()
                  this.notification.showDelete()
                  this.getRemedialData();
        ...
        // } 
        if (this.selectedIndex === 5) {
              this.deleteService.deleteVocationalNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, false).subscribe(res => {
                if (res.status === 200) {
                  this.resetTotal()
                  this.notification.showDelete()
                  this.getVocational();
              ...
              this.deleteService.deleteActivityNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, false).subscribe(res => {
                if (res.status === 200) {
                  this.resetTotal()
                  this.notification.showDelete()
                  this.getActivitiesData();
  ...
  restore(item: any) {
    ...
    this.common.delete().subscribe(res => {
      if (res) {
        if (this.selectedIndex === 0) {
          this.deleteService.deleteInfraNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, true).subscribe(res => {
            if (res.status === 200) {
              ...
              this.deleteService.deleteRenovatedNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, true).subscribe(res => {
                if (res.status === 200) {
                  this.getRenovationData();
                  this.resetTotal()
                  this.notification.showRestore()
         ...
         if (this.selectedIndex === 2) {
          this.deleteService.deleteEquipmentNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, true).subscribe(res => {
            if (res.status === 200) {
              this.resetTotal()
              this.notification.showRestore()
              this.getEquipmentData();
              ...
              this.deleteService.deleteWorkshopNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, true).subscribe(res => {
                if (res.status === 200) {
                  this.resetTotal()
                  this.notification.showRestore()
                  this.getWorkshop1();
           ...
           this.deleteService.deleteRemedialNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, true).subscribe(res => {
            if (res.status === 200) {
              this.resetTotal()
              this.notification.showRestore()
              this.getRemedialData();
        ...
        // } 
        if (this.selectedIndex === 5) {
          this.deleteService.deleteVocationalNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, true).subscribe(res => {
            if (res.status === 200) {
              this.resetTotal()
              this.notification.showRestore()
              this.getVocational();
        ...
        if (this.selectedIndex === 6) {
         this.deleteService.deleteActivityNMDCGenderRevision(item, this.sharedService.genderComponentId, this.sharedService.pabStatusV3, true).subscribe(res => {
            if (res.status === 200) {
              this.resetTotal()
              this.notification.showRestore()
              this.getActivitiesData();
