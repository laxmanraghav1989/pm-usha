...
@Component({
  selector: 'cfs-meru-sectionv3',
  templateUrl: './meru-sectionv3.component.html',
  styleUrls: ['./meru-sectionv3.component.scss'],
   providers: [
    { provide: DateAdapter, useClass: AppDateAdapter },
    { provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS }
  ],
})
export class MeruSectionv3Component implements OnInit {
...
addDepartmentData: boolean = false;
  ...
  constructor(
    ...
    public getService: GetService, public deleteService: DeleteService, public booleanEntity: BooleanEntity, private route: ActivatedRoute, public auth: CollegeService, private encrypt: EncryptDecrypt
  ) {
  ...
  saveTab1() {
    ...
    let temp = [];
      temp.push({
        ...
        rsV3: this.infraConstruction.controls["id"].value == 0 ? this.sharedService.revAddId : (this.infraConstruction.controls["rsV3"].value === '' ? null : this.infraConstruction.controls["rsV3"].value),
  ...
  delete(item: any) {
    ...
    this.common.delete().subscribe(res => {
      if (res) {
        if (this.selectedIndex === 0) {
            this.deleteService.deleteInfraRevision(item, this.sharedService.meruComponentId, this.sharedService.pabStatusV3, false).subscribe(res => {
              if (res.status === 200) {
                this.getInfraCons();
                this.resetTotal()
            ...
            this.deleteService.deleteRenovatedRevision(item, this.sharedService.meruComponentId, this.sharedService.pabStatusV3, false).subscribe(res => {
              if (res.status === 200) {
                this.getRenovated();
                this.resetTotal()
            ...
            this.deleteService.deleteEquipmentRevision(item, this.sharedService.meruComponentId, this.sharedService.pabStatusV3, false).subscribe(res => {
              if (res.status === 200) {
                this.getEquipment();
                this.resetTotal()
            ...
            this.deleteService.deleteSoftRevision(item, this.sharedService.meruComponentId, this.sharedService.pabStatusV3, false).subscribe(res => {
              if (res.status === 200) {
                this.getSoftCompoenent();
                this.resetTotal()
  ...
  restore(item: any) {
    ...
    this.common.restoreDelete("delete").subscribe(res => {
      if (res) {
        if (this.selectedIndex === 0) {
            this.deleteService.deleteInfraRevision(item, this.sharedService.meruComponentId, this.sharedService.pabStatusV3, true).subscribe(res => {
              if (res.status === 200) {
                this.getInfraCons();
                this.resetTotal()
            ...
            this.deleteService.deleteRenovatedRevision(item, this.sharedService.meruComponentId, this.sharedService.pabStatusV3, true).subscribe(res => {
              if (res.status === 200) {
                this.getRenovated();
                this.resetTotal()
            ...
            this.deleteService.deleteEquipmentRevision(item, this.sharedService.meruComponentId, this.sharedService.pabStatusV3, true).subscribe(res => {
              if (res.status === 200) {
                this.getEquipment();
                this.resetTotal()
            ...
            this.deleteService.deleteSoftRevision(item, this.sharedService.meruComponentId, this.sharedService.pabStatusV3, true).subscribe(res => {
              if (res.status === 200) {
                this.getSoftCompoenent();
                this.resetTotal()
                this.notification.showRestore()
