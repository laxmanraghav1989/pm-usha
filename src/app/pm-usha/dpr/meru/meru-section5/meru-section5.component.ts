...
@Component({
  selector: 'cfs-meru-section5',
  templateUrl: './meru-section5.component.html',
  styleUrls: ['./meru-section5.component.scss']
})
export class MeruSection5Component implements OnInit {
  ...
  constructor(
    ...
    public getSrevice: GetService, public deleteService: DeleteService,public postService:PostService, private route: ActivatedRoute
  ) {
  ...
  submitDocument(){
    ...
    if(this.dprValue == true || this.defaultValue == true){
      ...
      let payload = {
        ...
        districtCode: this.districtCode,
        instituteCategory: this.insType,
        componentId: this.insType === 'U' ? this.sharedService.meruComponentId : this.sharedService.collegeComponentId,
        documentTypeId:13,
