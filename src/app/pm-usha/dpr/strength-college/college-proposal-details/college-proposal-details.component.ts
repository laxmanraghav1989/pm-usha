...
@Component({
  selector: "cfs-college-proposal-details",
  templateUrl: "./college-proposal-details.component.html",
  styleUrls: ["./college-proposal-details.component.scss"],
  providers: [
    { provide: DateAdapter, useClass: AppDateAdapter },
    { provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS }
  ],
})
export class CollegeProposalDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    public common: Common, public deleteService: DeleteService, public booleanEntity: BooleanEntity, private route: ActivatedRoute
  ) {
  ...
  getInfraCons() {
    if (this.paramId === this.sharedService.revPrposal) {
      this.auth.getInfraCnstructionRevision(this.aisheCode, this.instituteCategory, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId, this.districtCode, "1").subscribe(
        (res) => {
      ...
      this.auth.getInfraCnstruction(this.aisheCode, this.instituteCategory, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId).subscribe(
        (res) => {
          this.processInfraResponse(res)
        },
        (err) => { }
  ...
  getRenovated() {
    if (this.paramId === this.sharedService.revPrposal) {
      ...
      this.auth.getRenovatedList(this.aisheCode, this.instituteCategory, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId).subscribe(
        (res) => {
          this.processRenovResponse(res)
        },
        (err) => { }
  ...
  processRenovResponse(res) {
    ...
    if (this.paramId === this.sharedService.revPrposal) {
      ...
      this.totalArr = this.renovatedList
  ...
  getEquipment() {
    if (this.paramId === this.sharedService.revPrposal) {
      ...
      this.auth.getEquipmentList(this.aisheCode, this.instituteCategory, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId).subscribe(
        (res) => {
          this.processEquoResponse(res)
        },
        (err) => { }
  ...
  getSoftCompoenent() {
    if (this.paramId === this.sharedService.revPrposal) {
      ...
      this.auth.getSoftCompoenentList(this.aisheCode, this.instituteCategory, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId).subscribe(
        (res) => {
          this.processsoftResponse(res)
        },
        (err) => { }
  ...
  processsoftResponse(res) {
    ...
    if (this.paramId === this.sharedService.revPrposal) {
      ...
      this.totalArr = this.softComponentList
  ...
  delete(item: any) {
    ...
    this.common.delete().subscribe(res => {
      if (res) {
        if (this.selectedIndex === 0) {
          if (this.paramId === this.sharedService.revPrposal) {
            this.deleteService.deleteInfraRevision(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId, "1", false).subscribe(res => {
              if (res.status === 200) {
            ...
            this.deleteService.deleteInfra(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId).subscribe(res => {
              if (res.status === 200) {
                this.notification.showDelete()
                this.resetTotal()
                this.getInfraCons();
          ...
          if (this.paramId === this.sharedService.revPrposal) {
            this.deleteService.deleteRenovatedRevision(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId, "1", false).subscribe(res => {
              if (res.status === 200) {
                // this.addUpdate=true
                this.resetTotal()
                this.notification.showDelete()
            ...
            this.deleteService.deleteRenovated(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId).subscribe(res => {
              if (res.status === 200) {
                // this.addUpdate=true
                this.resetTotal()
                this.notification.showDelete()
          ...
          if (this.paramId === this.sharedService.revPrposal) {
            this.deleteService.deleteEquipmentRevision(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId, "1", false).subscribe(res => {
              if (res.status === 200) {
                this.resetTotal()
                this.notification.showDelete()
                this.getEquipment();
            ...
            this.deleteService.deleteEquipment(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId).subscribe(res => {
              if (res.status === 200) {
                this.resetTotal()
                this.notification.showDelete()
                this.getEquipment();
          ...
          if (this.paramId === this.sharedService.revPrposal) {
            this.deleteService.deleteSoftRevision(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId, "1", false).subscribe(res => {
              if (res.status === 200) {
                this.resetTotal()
                this.notification.showDelete()
                this.getSoftCompoenent();
            ...
            this.deleteService.deleteSoft(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId).subscribe(res => {
              if (res.status === 200) {
                this.resetTotal()
                this.notification.showDelete()
                this.getSoftCompoenent();
  ...
  restore(item: any) {
    ...
    this.common.restoreDelete("delete").subscribe(res => {
      if (res) {
        if (this.selectedIndex === 0) {
          if (this.paramId === this.sharedService.revPrposal) {
            this.deleteService.deleteInfraRevision(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId, "1", true).subscribe(res => {
              if (res.status === 200) {
          ...
          if (this.paramId === this.sharedService.revPrposal) {
            this.deleteService.deleteRenovatedRevision(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId, "1", true).subscribe(res => {
              if (res.status === 200) {
                // this.addUpdate=true
                this.resetTotal()
                this.notification.showRestore()
          ...
          if (this.paramId === this.sharedService.revPrposal) {
            this.deleteService.deleteEquipmentRevision(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId, "1", true).subscribe(res => {
              if (res.status === 200) {
                this.resetTotal()
                this.notification.showRestore()
                this.getEquipment();
          ...
          if (this.paramId === this.sharedService.revPrposal) {
            this.deleteService.deleteSoftRevision(item, this.insType === 'U' ? this.sharedService.universityComponentId : this.sharedService.collegeComponentId, "1", true).subscribe(res => {
              if (res.status === 200) {
                this.resetTotal()
                this.notification.showRestore()
                this.getSoftCompoenent();
