...
@Component({
  selector: "cfs-college-outcomes",
  templateUrl: "./college-outcomes.component.html",
  styleUrls: ["./college-outcomes.component.scss"],
  providers: [
    { provide: DateAdapter, useClass: AppDateAdapter },
    { provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS }
  ],
})
export class CollegeOutcomesComponent implements OnInit {
  SampleForm: any;
