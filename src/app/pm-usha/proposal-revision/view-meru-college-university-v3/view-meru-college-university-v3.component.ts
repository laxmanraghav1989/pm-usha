...
@Component({
  selector: 'cfs-view-meru-college-university-v3',
  templateUrl: './view-meru-college-university-v3.component.html',
  styleUrls: ['./view-meru-college-university-v3.component.scss']
})
export class ViewMeruCollegeUniversityV3Component implements OnInit {
