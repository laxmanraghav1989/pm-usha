...
@Component({
  selector: 'cfs-view-meru-revision',
  templateUrl: './view-meru-revision.component.html',
  styleUrls: ['./view-meru-revision.component.scss']
})
export class ViewMeruRevisionComponent implements OnInit {
