...
@Component({
  selector: 'cfs-outcome-view-strength',
  templateUrl: './outcome-view-strength.component.html',
  styleUrls: ['./outcome-view-strength.component.scss']
})
export class OutcomeViewStrengthComponent implements OnInit {
