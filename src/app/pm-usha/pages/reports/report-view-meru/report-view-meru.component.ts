...
@Component({
  selector: 'cfs-report-view-meru',
  templateUrl: './report-view-meru.component.html',
  styleUrls: ['./report-view-meru.component.scss']
})
export class ReportViewMeruComponent implements OnInit {
