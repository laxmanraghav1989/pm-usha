...
@Component({
  selector: 'cfs-gender-pmusha-list',
  templateUrl: './gender-pmusha-list.component.html',
  styleUrls: ['./gender-pmusha-list.component.scss']
})
export class GenderPmushaListComponent implements OnInit {
  ...
  constructor(    public api: ApiService, public common: Common,public notification:NotificationService,public masterService:MasterService, 
    public sharedService: SharedService, public router: Router,private route: ActivatedRoute, public getService: GetService,public postService:PostService, public encrypt: EncryptDecrypt) {
      ...
      if (this.userTypeId === this.sharedService.userTypeList['1'].id || this.userTypeId === this.sharedService.userTypeList['2'].id || this.userTypeId === this.sharedService.userTypeList['3'].id) {
  ...
  genderList() {
    ...
    if(this.revision === this.sharedService.revPrposal) {
      ...
      this.genderListData = this.genderListData.filter(e => e.pabActionId == 1 || e.pabActionId == 3)
        ...
        if ((this.userTypeId === this.sharedService.userTypeList['0'].id || this.userTypeId === this.sharedService.userTypeList['6'].id || this.userTypeId === this.sharedService.userTypeList['7'].id) && this.revision === this.sharedService.revPrposal){
          this.genderListData = this.genderListData.filter(e => e.revisedProposalForwardedtoNpd)
        }
      ...
      this.genderListData = this.genderListData.filter(e => e.pabActionId == 1 || e.pabActionId == 3)
        ...
        if (this.userTypeId === this.sharedService.userTypeList['0'].id && this.revision === this.sharedService.revPrposal){
          this.genderListData = this.genderListData.filter(e => e.revisedProposalForwardedtoNpd)
  ...
  datailsList(ele: any): void {
    ...
    this.router.navigate([this.routers.viewGenderEquity, 10])
    }
    if (this.userTypeId === this.sharedService.userTypeList['1'].id || this.userTypeId === this.sharedService.userTypeList['2'].id || this.userTypeId === this.sharedService.userTypeList['3'].id || this.userTypeId === this.sharedService.userTypeList['0'].id || this.userTypeId === this.sharedService.userTypeList['8'].id || this.userTypeId === this.sharedService.userTypeList['9'].id || this.userTypeId === this.sharedService.userTypeList['6'].id || this.userTypeId === this.sharedService.userTypeList['7'].id) {
      if (this.componentId == this.sharedService.nmdcComponentId && this.revision !== this.sharedService.revPrposal){
        this.router.navigate([this.routers.viewinstNMDC, this.componentId])
      }
      else if (this.componentId == this.sharedService.nmdcComponentId && this.revision === this.sharedService.revPrposal){
        this.router.navigate([this.routers.viewNMDCRevision, this.componentId])
      }
      else if (this.componentId == this.sharedService.genderComponentId && this.revision === this.sharedService.revPrposal) {
        this.router.navigate([this.routers.viewEquityRevision, this.componentId])
      }
      else if (this.componentId == this.sharedService.genderComponentId && this.revision !== this.sharedService.revPrposal) {
        this.router.navigate([this.routers.viewinsGenderEquity, this.componentId])
      }
    }
    else {
     this.router.navigate([this.routers.viewNmdc, 10])
    }
    }
