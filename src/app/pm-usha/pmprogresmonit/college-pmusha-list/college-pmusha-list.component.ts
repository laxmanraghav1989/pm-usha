...
@Component({
  selector: 'cfs-college-pmusha-list',
  templateUrl: './college-pmusha-list.component.html',
  styleUrls: ['./college-pmusha-list.component.scss']
})
export class CollegePmushaListComponent implements OnInit {
  ...
  datailsList(ele: any): void {
    ...
    if (this.userTypeId === this.sharedService.userTypeList['1'].id || this.userTypeId === this.sharedService.userTypeList['2'].id || this.userTypeId === this.sharedService.userTypeList['3'].id || this.userTypeId === this.sharedService.userTypeList['0'].id || this.userTypeId === this.sharedService.userTypeList['8'].id || this.userTypeId === this.sharedService.userTypeList['9'].id || this.userTypeId === this.sharedService.userTypeList['6'].id || this.userTypeId === this.sharedService.userTypeList['7'].id) {
      if (this.componentId === '3' && this.revision !== this.sharedService.revPrposal) {
        this.router.navigate([this.routers.viewinstCollege, this.componentId])
      }
      else if (this.componentId === '3' || this.componentId === '2' && this.revision === this.sharedService.revPrposal) {
        this.router.navigate([this.routers.viewStrengthenRevision, this.componentId])
      }
      else if (this.componentId === '1' && this.revision === this.sharedService.revPrposal) {
        this.router.navigate([this.routers.viewMeruRevision, this.componentId])
      }
      else if (this.componentId === '2') {
        this.router.navigate([this.routers.viewinstUniver, this.componentId])
      }
      else {
        this.router.navigate([this.routers.viewinstMeru, this.componentId])
      }
    }
    else {
      this.router.navigate([this.routers.viewCollege, 10])
    }
